...
Проект использует **Yandex Foundation Models (YandexGPT)** и три техники промптинга (zero-shot, CoV+CoK, few-shot) для создания качественных постов для фитнес-зала Натриум.

---

## ✨ Возможности

- 📝 **Автоматическая генерация тем** — 10 актуальных идей для постов на основе CrossFit, ЗОЖ, научных исследований
...
- 🎯 **Три техники промптинга**:
  ...
  - `cov+cok` — с проверкой фактов через Chain-of-Verification и Chain-of-Knowledge
  - `few_shot` — обучение на примерах из базы знаний
- 📚 **База знаний**:
